...
const CartItem: React.FC<CartItemProps> = ({ id, title, imageUrl, price, sizes, count }) => {
    ...
    <>
      <div className="cart__order">
        <div className="cart__item">
          ...
          <div className="cart__name">{title}</div>
        </div>
        ...
        <div className="cart__amount">
          <button className="cart__minus" onClick={onClickMinus}>
            <svg
              width="10"
              height="2"
              viewBox="0 0 10 2"
        ...
        <div className="cart__price">
          <div className="cart__sum">{price * count} грн</div>
